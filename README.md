...
In our study, we present strategies for drug design using Acr proteins as well as a new family of Acr proteins, structurally similar to Acr protein that show enzymatic activities, unlike previously discovered ones. For this, we make use of the aforementioned AlphaFold to predict the 3-D structures of Acr proteins and perform structural and sequence analysis using the results.
